          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <div className="flex items-center space-x-3 relative">
                ...
                <div>
                  <span className="text-white text-2xl font-bold drop-shadow-lg font-poppins">Gregorian Club</span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-center md:text-left backdrop-blur-sm bg-black/20 rounded-xl p-4 md:p-2">
            <p className="text-gray-200 text-sm drop-shadow font-poppins">
              &copy; {new Date().getFullYear()} Gregorian Club. All rights reserved.
            </p>
