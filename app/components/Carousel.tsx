...
const STATIC_SLIDES: Slide[] = [
  {
    _id: '1',
    title: 'Welcome to Gragorian Club',
      ...
      <div className="relative min-h-[calc(100vh-64px)] md:h-175 overflow-hidden">
        {slides.map((slide, index) => (
          ...
          >
            ...
            {/* Gradient Overlay */}
            <div className={`absolute inset-0 bg-gradient-to-b ${slide.overlayColor || 'from-blue-900/40 via-emerald-700/20 to-transparent'}`} />
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4 md:px-6 lg:px-8">
              ...
              {/* Slide Title */}
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 drop-shadow-2xl max-w-4xl">
                {slide.title}
              </h2>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-4">
                {slide.ctaPrimary && (
                  <a
                    ...
                    className="inline-flex items-center bg-white text-gray-900 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg group"
                  >
            ...
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                index === currentIndex
                  ...
                  : 'bg-white/50 hover:bg-white/80 hover:w-4'
              }`}
